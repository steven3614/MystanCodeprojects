...
Name: 張文銓
------------------------
TODO: this function add two listnode together and return another linked list
"""
...
def add_2_numbers(l1: ListNode, l2: ListNode) -> ListNode:
    #######################
    #                     #
    #        TODO: this function add two list node together        #
    #                     #
    #######################
    head = ListNode(0)
    cur = head
    pointer = cur
    ans = 0
    while l1 is not None or l2 is not None or ans is not 0:
        if l1 is None:
            pass
        else:
            ans += l1.val
